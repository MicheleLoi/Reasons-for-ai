...
- *Externalist intuition preserved*: the *intentional content* of the justifications the screening system produces is world-directed — in deliberation the agent attends to your pain, not to herself.
...
The form of externalism in play here is the standard semantic externalism of Putnam (1975), Burge (1979, 1993), and Kripke (1980). Content-directedness on this view is fixed by causal-historical chains and the social division of linguistic labour. The screening system can be confirmation-biased and individually unreliable in the way Mercier and Sperber describe, while the *content* of what it produces remains world-directed in virtue of meta-semantic facts that obtain at the level of the linguistic community.

> *Note. Externalism and Mercier–Sperber do orthogonal jobs. Externalism handles the* aboutness *question — how is content world-directed? — via causal-historical chains and the social division of linguistic labour. M&S handles the* cognitive-operation *question — what kind of system generates and evaluates these contents, and when is its screening operation causally upstream of behavior? The criterion in (i)–(iii) above is M&S's contribution; without M&S there is no criterion. The open question on which the paper most needs Mercier's judgment: is the production-and-screening architecture the right kind of cognitive operation to ground the reasons-responsive / rationalization distinction in §5a — and in particular, can the screening operation be causally upstream of action-generation in the way the criterion requires?*
...
> *Note — to discuss. The argument here is structurally parallel to §3 but meaningfully weaker. §3 leans on phenomenology — the deliberating subject's first-person experience of attending to the world. The LLM case has only output structure, and output structure is precisely what next-token prediction trained on human justificatory discourse is optimized to produce regardless of whether anything internal corresponds to world-directedness. The §6.5b externalist meta-semantics is what the paper offers in response: world-directedness of content does not have to be read off output structure if it is grounded in the causal-historical chains running through the training corpus. On this construal the response to the mimicry concern is symmetric with §5b — for both humans and LLMs, content-directedness is meta-semantically fixed, not phenomenologically read.*
...
- *Externalist intuition preserved*: the *intentional content* of the justifications the model produces is world-directed, because the system was trained to produce justifications about features of situations (harm, consistency, fairness, factual accuracy), not features of itself.
